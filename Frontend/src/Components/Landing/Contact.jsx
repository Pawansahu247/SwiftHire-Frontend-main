                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-600">
                            Whether you're looking to join as an interviewer, explore pricing, or simply want to learn more about SwiftHire — we're here to help.
                            <br /><br />
                            📩 For pricing details or to become an interviewer:<br />
                            Fill out the form below or email us directly at swifthire.official@gmail.com
                            <br /><br />
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
                                ...
                                <div className="space-y-3">
                                    <a href="mailto:swifthire.official@gmail.com" className="flex items-center gap-2 text-gray-600 hover:text-[#E65F2B] transition-colors">
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                                            <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                                        </svg>
                                        <span className="truncate">swifthire.official@gmail.com</span>
                                    </a>
                                    <a href="tel:+918815638774" className="flex items-center gap-2 text-gray-600 hover:text-[#E65F2B] transition-colors">
                                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
