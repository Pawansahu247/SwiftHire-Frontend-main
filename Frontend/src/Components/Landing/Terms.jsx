    ...
    return (
        <div className="min-h-screen py-12 px-6 sm:px-6 lg:px-8 bg-[#F1F5F9] font-montserrat">
            <div className="max-w-3xl mx-auto">
                ...
                <section className="mb-4">
                    <p className="text-gray-700 mb-2">
                        Welcome to SwiftHire ("we," "our," or "us"). These Terms and Conditions ("Terms") govern your access to and use of our platform, services, and website (the "Service"). By accessing or using SwiftHire, you agree to comply with and be bound by these Terms.
                    </p>
                </section>
                ...
                <section className="mb-4">
                    ...
                    <p className="text-gray-700 mb-4">
                        SwiftHire provides a tech hiring platform to help companies screen, interview, and hire engineering candidates efficiently. Our services include but are not limited to resume screening, mock interviews, expert-led evaluations, and reporting tools.
                    </p>
                </section>
                ...
                <section className="mb-4">
                    ...
                    <p className="text-gray-700">
                        You agree to use SwiftHire only for lawful purposes. You may not use the platform:
                    </p>
                ...
                <section className="mb-4">
                    ...
                    <p className="text-gray-700 mb-4">
                        All content on SwiftHire, including text, logos, branding, and software, is our property or licensed to us. You may not reproduce, distribute, or create derivative works without our written permission.
                    </p>
                </section>
                <section className="mb-4">
                ...
                <section className="mb-4">
                    ...
                    <p className="text-gray-700 mb-4">
                        We reserve the right to suspend or terminate your access to SwiftHire at any time, without prior notice, for conduct that violates these Terms or is otherwise harmful.
                    </p>
                </section>
                ...
                <section className="mb-4">
                    ...
                    <p className="text-gray-700 mb-4">
                        SwiftHire is provided "as is" without warranties of any kind. We do not guarantee hiring outcomes or uninterrupted service availability.
                    </p>
                </section>
                ...
                <section className="mb-4">
                    ...
                    <p className="text-gray-700 mb-4">
                        To the maximum extent permitted by law, SwiftHire shall not be liable for any indirect, incidental, or consequential damages resulting from your use of the Service.
                    </p>
                </section>
            ...
            <ConfirmDialog
                ...
                message="This will open your default email client to send an email to swifthire.official@gmail.com"
            />
        </div >
    );
};
